...
.. method:: do.droplet.create(attribs=None)
...
.. method:: do.droplet.backup_enable(id=None, tag_name=None)
...
.. method:: do.droplet.backup_disable(id=None, tag_name=None)
...
.. method:: do.droplet.shutdown(id=None, tag_name=None)
...
.. method:: do.droplet.power_on(id=None, tag_name=None)
...
.. method:: do.droplet.power_off(id=None, tag_name=None)
...
.. method:: do.droplet.power_cycle(id=None, tag_name=None)
...
.. method:: do.droplet.restore(id, image)
...
.. method:: do.droplet.password_reset(id)
...
.. method:: do.droplet.resize(id, size, disk=False)
...
.. method:: do.droplet.rebuild(id, image)
...
.. method:: do.droplet.rename(id, name)
...
.. method:: do.droplet.kernel_update(id, kernel_id)
...
.. method:: do.droplet.ipv6_enable(id=None, tag_name=None)
...
.. method:: do.droplet.private_networking_enable(id=None, tag_name=None)
...
At the time of this writing, snapshotting by tag is not working properly and is not recommended.


.. method:: do.droplet.snapshot_create(id=None, tag_name=None, snapshot_name=None)
...
* `<https://developers.digitalocean.com/documentation/v2/#snapshot-a-droplet>`_
